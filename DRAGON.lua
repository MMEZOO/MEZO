...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥\n\27[0;33;49m')
...
io.write('\27[1;31m ◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
local Text = ' ☻تم ارسال الملصق من ◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥\n - '..Name
...
t = ' ☻ ملفات السورس ميزو◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥\n 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅??𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
send(msg.chat_id_, msg.id_, t..'◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥\nاضغط علي الاسم ليتم نسخه\n◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥ٴ\n ☻ ❲[《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》 ](t.me/mezo571)❳ ☻ ')
end
...
[[
🌨◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥Use ⇨ #username 🌨
🌨◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥iD ⇨ #id 🌨
🌨◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥Sta ⇨  #stast 🌨
🌨◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥Msg ⇨ #msgs 🌨
🌨◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥??𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ☻  
↑◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥𝙄𝘿 ➱ #id
↑◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥𝙍𝘼𝙉𝙆 ➱  #stast ☻  
↑◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥𝙈𝘼𝙎𝙂 ➱ #msgs ☻  
↑◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥𝗖𝗛 ➯  ↝@mezo571↜ ☻  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
local Text = [[
 ...
 تحت لي في الزر الأسفل◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥
 اختر الامر الذي تريدها .↑◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥
ده من الازرار بلاسفل . ◤━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━◥
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》 ](t.me/mezo571)❳ 
]]
keyboard = {} 
